...
export type UsernameError = 'too_short' | 'too_long' | 'invalid_chars' | 'invalid_edge' | 'consecutive_dots';
...
/**
 * Validates a username. Mirrors the `username_format` check constraint in the database.
